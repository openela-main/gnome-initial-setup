...
* Mon Jan 12 2026 nmontero <nmontero@redhat.com> - 46.7-3
- account: Don't draw the avatar button background

* Wed Sep 03 2025 Tomas Pelka <tpelka@redhat.com> - 46.7-2
- Use systemd sysusers config to create user and group

* Mon Mar 17 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 46.7-1
- Update to 46.7

* Fri Mar 14 2025 Adam Williamson <awilliam@redhat.com> - 46.alpha-15
- Revert vendor.conf for webui deferral

* Fri Mar 14 2025 Adam Williamson <awilliam@redhat.com> - 46.alpha-14
- Update file list for dropping of live user mode patch

* Fri Mar 14 2025 Adam Williamson <awilliam@redhat.com> - 46.alpha-13
- Drop live user mode patch: Change was deferred to F41

* Fri Mar 14 2025 Florian Müllner <fmuellner@gnome.org> - 46.alpha-12
- Adjust downstream patch

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 46.alpha-11
